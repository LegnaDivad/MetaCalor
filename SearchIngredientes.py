...
from Cartas import CartaIngredienteBuscador
from AlertDialog import RegisterDialog

class SearchIngredientes(ft.UserControl):
    def __init__(self, route):
        super().__init__()
        self.route = route
        self.list = self.route.crearPlatillo.listaIngredientes
    ...
    def buscarElementos(self,e):
        ...
        for datos in resultado:
            item = CartaIngredienteBuscador(self.route,datos, self.list)
    ...
    def inicializar(self):
        ...
        print('Inicializando buscador Inngredientes')